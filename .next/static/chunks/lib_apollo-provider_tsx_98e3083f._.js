...
function ApolloWrapper(param) {
    ...
    const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ApolloWrapper.useMemo[client]": ()=>{
            const authLink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$link$2f$context$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setContext"])({
                "ApolloWrapper.useMemo[client].authLink": async (_, param)=>{
                    let { headers } = param;
            ...
            }["ApolloWrapper.useMemo[client].authLink"]);
...
_s(ApolloWrapper, "JjDSBLTo05dx9pvJFGjimOjVnAk=", false, function() {
    return [
...
//# sourceMappingURL=lib_apollo-provider_tsx_98e3083f._.js.map